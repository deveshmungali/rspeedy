      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="font-semibold"> Preferred Card </TableHead>
        ...
        <TableBody>
          {users.map((item) => (
            <TableRow key={item.email} className="hover:bg-muted">
              ...
              <TableCell className="text-m font-semibold"> {item.name} </TableCell>

              <TableCell className="text-m font-semibold"> {item.card} </TableCell>

              <TableCell className="text-m font-semibold"> {item.card_number} </TableCell>
