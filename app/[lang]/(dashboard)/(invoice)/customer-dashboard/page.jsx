  ...
  return (
    <div>
      ...
      <div className="flex mt-6 flex-col gap-4">
        ...
        <div className="p-3 rounded-lg bg-red-300 border-2 border-red-600">
          <div className="flex justify-between items-center">
            <p> Pageview limit is reached, please upgrade your plan.</p>
            <Button href="./plans" className="bg-red-600"> Upgrade Plan </Button>
          </div>
        </div>
      </div>
