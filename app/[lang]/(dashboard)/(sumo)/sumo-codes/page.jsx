...
import CodeStats from "./sumo-codes"
import SumoListTable from "./sumo-codes-list-table"
  ...
  return (
    <Fragment>
      <Breadcrumbs>
        ...
        <BreadcrumbItem>Codes</BreadcrumbItem>
      </Breadcrumbs>
      <Card className="mt-6">
        <CardHeader className="flex-row items-center border-none mb-0">
          <CardTitle className="flex-1 text-xl font-medium text-default-900">App Sumo Code Overview</CardTitle>
          <Button
