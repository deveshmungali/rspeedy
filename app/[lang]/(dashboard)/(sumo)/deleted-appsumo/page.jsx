...
import DeletedSumoStats from "./deleted-stats"
import DeletedSumoListTable from "./deleted-appcodes-list-table"
    ...
    <Fragment>
      ...
      <Card className="mt-6">
        <CardHeader className="flex-row items-center border-none mb-0">
          <CardTitle className="flex-1 text-xl font-medium text-default-900">Deleted App Sumo Customers Overview</CardTitle>
          <Button
